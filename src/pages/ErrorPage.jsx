            ...
            <div className='container flex items-center min-h-screen px-6 py-12 mx-auto'>
                <div className='flex flex-col items-center max-w-sm mx-auto text-center'>
                    ...
                    <div className='flex items-center w-full mt-6 gap-x-3 shrink-0 sm:w-auto'>
                        ...
                        <button className='flex items-center justify-center w-1/2 px-5 py-1 text-sm transition-colors duration-200 text-white border rounded-lg gap-x-2 sm:w-auto   hover:bg-rose-400 bg-rose-500' onClick={() => navigate('/')} >Take Me Home</button>
                    </div>
                </div>
            </div>
        </section>
